...
function EditComponent() {
    const useMeLater = (
        ...
        <h1 className="headline headline--large">
          Welcome! <i className="bi bi-x-square-fill"></i>{" "}
        </h1>
  ...
  return (
    <div className="page-banner">
      <div className="page-banner__bg-image" style={{ backgroundImage: "url('/wp-content/themes/lux-block-theme/images/library-hero.jpg')"}}></div>
