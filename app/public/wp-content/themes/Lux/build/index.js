...
class Search {
  constructor() {
    this.addSearchHTML();
    this.reasultDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-overlay_results");
  ...
  keyPressDispatcher(e) {
    if (e.keyCode == 70 && !this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(':focus')) {
      this.openOverlay();
    }
